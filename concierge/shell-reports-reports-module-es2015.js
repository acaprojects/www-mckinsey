...
/* harmony import */ var src_app_services_data_reports_report_class__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/services/data/reports/report.class */ "./src/app/services/data/reports/report.class.ts");
...
/* harmony import */ var _shared_components_custom_fields_date_field_date_field_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../../shared/components/custom-fields/date-field/date-field.component */ "./src/app/shared/components/custom-fields/date-field/date-field.component.ts");
...
/* harmony import */ var _report_table_report_table_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../report-table/report-table.component */ "./src/app/shell/reports/report-table/report-table.component.ts");
...
function ReportDisplayComponent_mat_form_field_13_span_4_Template(rf, ctx) { if (rf & 1) {
...
function ReportDisplayComponent_mat_form_field_13_mat_option_5_Template(rf, ctx) { if (rf & 1) {
...
function ReportDisplayComponent_mat_form_field_13_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function ReportDisplayComponent_mat_form_field_13_Template_mat_select_ngModelChange_1_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r13); const ctx_r12 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r12.locations = $event; });
...
function ReportDisplayComponent_ng_template_17_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "mat-spinner", 27);
} }
const _c0 = function () { return []; };
function ReportDisplayComponent_ng_container_22_ng_container_1_Template(rf, ctx) { if (rf & 1) {
...
function ReportDisplayComponent_ng_container_22_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerStart"](0);
...
const _c1 = function () { return { class: "material-icons", content: "arrow_upward" }; };
function ReportDisplayComponent_ng_template_23_Template(rf, ctx) { if (rf & 1) {
...
function ReportDisplayComponent_ng_template_25_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 29);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "div", 30);
...
class ReportDisplayComponent {
    ...
    ngOnInit() {
        this._service.Organisation.initialised.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["first"])(_ => _)).subscribe(() => {
    ...
    generateReport() {
        ...
        if (this.report) {
            ...
            this._service.Reports.show(this.report.id, {
                ...
                this.loading = false;
                this.report_data = new src_app_services_data_reports_report_class__WEBPACK_IMPORTED_MODULE_2__["Report"](Object.assign(Object.assign({}, report), { type: this.report.id }));
            }, (err) => {
                this.loading = false;
                this._service.notifyError(`Error generating report. Error: ${err.message || err}`);
            });
        }
    }
    downloadReport() {
        /* istanbul ignore else */
        if (this.report_data) {
            const date = dayjs__WEBPACK_IMPORTED_MODULE_3__(this.start_date).format('YYYY-MM-DD');
            this.report_data.downloadCSV(`${this.report.name.split(' ').join('_').toLowerCase()}+${date}.csv`);
        }
    }
}
ReportDisplayComponent.ɵfac = function ReportDisplayComponent_Factory(t) { return new (t || ReportDisplayComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_services_app_service__WEBPACK_IMPORTED_MODULE_4__["ApplicationService"])); };
ReportDisplayComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ReportDisplayComponent, selectors: [["a-report-display"]], inputs: { report: "report" }, features: [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵNgOnChangesFeature"]], decls: 27, vars: 13, consts: [[1, "header"], [1, "period"], [1, "field"], ["for", "start-date"], ["name", "start-date", 3, "ngModel", "from", "to", "ngModelChange"], [1, "gap"], ["for", "end-date"], ["name", "end-date", 3, "ngModel", "from", "to", "ngModelChange"], [1, "location", "dark-mode"], ["appearance", "outline", 4, "ngIf"], [1, "actions"], ["mat-button", "", "name", "generate", 3, "disabled", "tapped"], [4, "ngIf", "ngIfElse"], ["gen_loader", ""], ["mat-button", "", "name", "download", 3, "disabled", "tapped"], [1, "display"], ["empty_state", ""], ["load_state", ""], ["appearance", "outline"], ["name", "locations", "multiple", "", 3, "ngModel", "ngModelChange"], ["class", "selection", 4, "ngIf"], [3, "value", 4, "ngFor", "ngForOf"], [1, "selection"], [3, "value"], [1, "option"], [1, "code"], [1, "name"], ["diameter", "32"], [3, "list", "details"], [1, "info-block", "center"], [1, "icon"], [3, "icon"], [1, "text"]], template: function ReportDisplayComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function ReportDisplayComponent_Template_a_date_field_ngModelChange_5_listener($event) { return ctx.start_date = $event; });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function ReportDisplayComponent_Template_a_date_field_ngModelChange_11_listener($event) { return ctx.end_date = $event; });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("tapped", function ReportDisplayComponent_Template_button_tapped_15_listener() { return ctx.generateReport(); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("tapped", function ReportDisplayComponent_Template_button_tapped_19_listener() { return ctx.downloadReport(); });
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ReportDisplayComponent, [{
    ...
    }], function () { return [{ type: src_app_services_app_service__WEBPACK_IMPORTED_MODULE_4__["ApplicationService"] }]; }, { report: [{
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ReportTableComponent", function() { return ReportTableComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
...
function ReportTableComponent_ng_container_1_th_1_Template(rf, ctx) { if (rf & 1) {
    ...
    const key_r3 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().$implicit;
...
function ReportTableComponent_tr_2_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "tr", 9);
} }
function ReportTableComponent_tr_3_Template(rf, ctx) { if (rf & 1) {
...
ReportTableComponent.ɵfac = function ReportTableComponent_Factory(t) { return new (t || ReportTableComponent)(); };
ReportTableComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ReportTableComponent, selectors: [["a-report-table"]], inputs: { list: "list", details: "details" }, features: [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵNgOnChangesFeature"]], decls: 4, vars: 4, consts: [["cdk-table", "", 3, "dataSource"], [3, "cdkColumnDef", 4, "ngFor", "ngForOf"], ["cdk-header-row", "", 4, "cdkHeaderRowDef"], ["cdk-row", "", 4, "cdkRowDef", "cdkRowDefColumns"], [3, "cdkColumnDef"], ["cdk-header-cell", "", 4, "cdkHeaderCellDef"], ["cdk-cell", "", 4, "cdkCellDef"], ["cdk-header-cell", ""], ["cdk-cell", ""], ["cdk-header-row", ""], ["cdk-row", ""]], template: function ReportTableComponent_Template(rf, ctx) { if (rf & 1) {
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ReportTableComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
...
function ReportsComponent_div_4_mat_form_field_1_mat_option_2_Template(rf, ctx) { if (rf & 1) {
...
function ReportsComponent_div_4_mat_form_field_1_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function ReportsComponent_div_4_mat_form_field_1_Template_mat_select_ngModelChange_1_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r8); const ctx_r7 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](2); return ctx_r7.active_report = $event; })("ngModelChange", function ReportsComponent_div_4_mat_form_field_1_Template_mat_select_ngModelChange_1_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r8); const ctx_r9 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](2); return ctx_r9.updateReport(); });
...
function ReportsComponent_div_4_Template(rf, ctx) { if (rf & 1) {
...
function ReportsComponent_div_6_a_1_Template(rf, ctx) { if (rf & 1) {
...
function ReportsComponent_ng_template_7_Template(rf, ctx) { if (rf & 1) {
...
class ReportsComponent extends src_app_shared_base_directive__WEBPACK_IMPORTED_MODULE_1__["BaseDirective"] {
...
ReportsComponent.ɵfac = function ReportsComponent_Factory(t) { return new (t || ReportsComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"])); };
ReportsComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ReportsComponent, selectors: [["a-reports"]], features: [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵInheritDefinitionFeature"]], decls: 9, vars: 4, consts: [[1, "reports"], [1, "group"], [3, "date", "dateChange"], ["class", "topbar", 4, "ngIf"], ["class", "options", 4, "ngIf", "ngIfElse"], ["report_display", ""], [1, "topbar"], ["appearance", "outline", 4, "ngIf"], ["appearance", "outline"], [3, "ngModel", "ngModelChange"], [3, "value", 4, "ngFor", "ngForOf"], [3, "value"], [1, "options"], ["class", "card", "mat-button", "", 3, "routerLink", 4, "ngFor", "ngForOf"], ["mat-button", "", 1, "card", 3, "routerLink"], [1, "content"], [1, "icon"], [3, "icon"], [1, "details"], [1, "desc"], [3, "report"]], template: function ReportsComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("dateChange", function ReportsComponent_Template_a_topbar_header_dateChange_3_listener($event) { return ctx.date = $event; });
    ...
    } }, styles: ["[_nghost-%COMP%], .reports[_ngcontent-%COMP%], main[_ngcontent-%COMP%] {\n  height: 100%;\n  width: 100%;\n}\n.reports[_ngcontent-%COMP%] {\n  display: flex;\n  height: 100vh;\n  background-color: #ecf1f5;\n}\nmain[_ngcontent-%COMP%] {\n  height: calc(100% - 3.5em);\n}\n.group[_ngcontent-%COMP%] {\n  flex: 1;\n  min-width: 12em;\n}\n.topbar[_ngcontent-%COMP%] {\n  padding: 0.1em 0 0.1em 0.5em;\n  height: 3.5em;\n}\n.topbar[_ngcontent-%COMP%]   mat-form-field[_ngcontent-%COMP%] {\n  margin-right: 0.5em;\n  width: 18em;\n}\nh3[_ngcontent-%COMP%] {\n  font-weight: 300;\n  margin-top: 0;\n}\n.options[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  height: 100%;\n  width: 100%;\n}\n.card[_ngcontent-%COMP%] {\n  padding: 0;\n  border: 1px solid #ccc;\n  border-radius: 4px;\n  box-shadow: 0 1px 3px 0px rgba(0, 0, 0, 0.2), 0 1px 1px 0 rgba(0, 0, 0, 0.14), 0 2px 1px -1px rgba(0, 0, 0, 0.12);\n  margin: 1em;\n  padding: 1em;\n  font-weight: 300;\n  background-color: #fff;\n  height: 20em;\n}\n.card[_ngcontent-%COMP%]   .content[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  flex-direction: column;\n}\n.card[_ngcontent-%COMP%]   .icon[_ngcontent-%COMP%]    > app-icon[_ngcontent-%COMP%] {\n  font-size: 6em;\n  color: #1937ea;\n}\n.card[_ngcontent-%COMP%]   .details[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n}\n.card[_ngcontent-%COMP%]   .details[_ngcontent-%COMP%]    > app-icon[_ngcontent-%COMP%] {\n  font-size: 2em;\n}\n.card[_ngcontent-%COMP%]   .desc[_ngcontent-%COMP%] {\n  width: 12em;\n  margin-left: 2.5em;\n  white-space: pre-wrap;\n  line-height: 1.3em;\n  color: rgba(0, 0, 0, 0.6);\n}\n/*# sourceMappingURL=data:application/json;base64, */"] });
...
/* harmony import */ var _reports_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./reports.component */ "./src/app/shell/reports/reports.component.ts");
/* harmony import */ var src_app_shared_shared_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/app/shared/shared.module */ "./src/app/shared/shared.module.ts");
/* harmony import */ var _report_display_report_display_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./report-display/report-display.component */ "./src/app/shell/reports/report-display/report-display.component.ts");
/* harmony import */ var _report_table_report_table_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./report-table/report-table.component */ "./src/app/shell/reports/report-table/report-table.component.ts");
...
/* harmony import */ var _acaprojects_ngx_date_picker__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @acaprojects/ngx-date-picker */ "./node_modules/@acaprojects/ngx-date-picker/__ivy_ngcc__/fesm2015/acaprojects-ngx-date-picker.js");
/* harmony import */ var _shared_base_directive__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../shared/base.directive */ "./src/app/shared/base.directive.ts");
/* harmony import */ var _shared_components_login_login_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../shared/components/login/login.component */ "./src/app/shared/components/login/login.component.ts");
...
/* harmony import */ var _shared_components_action_icon_action_icon_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../../shared/components/action-icon/action-icon.component */ "./src/app/shared/components/action-icon/action-icon.component.ts");
/* harmony import */ var _shared_components_topbar_header_topbar_header_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../../shared/components/topbar-header/topbar-header.component */ "./src/app/shared/components/topbar-header/topbar-header.component.ts");
/* harmony import */ var _shared_components_searchbar_searchbar_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../../shared/components/searchbar/searchbar.component */ "./src/app/shared/components/searchbar/searchbar.component.ts");
/* harmony import */ var _shared_components_user_avatar_user_avatar_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../../shared/components/user-avatar/user-avatar.component */ "./src/app/shared/components/user-avatar/user-avatar.component.ts");
/* harmony import */ var _shared_components_forms_user_form_user_form_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../../shared/components/forms/user-form/user-form.component */ "./src/app/shared/components/forms/user-form/user-form.component.ts");
/* harmony import */ var _shared_components_forms_booking_form_booking_form_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ../../shared/components/forms/booking-form/booking-form.component */ "./src/app/shared/components/forms/booking-form/booking-form.component.ts");
/* harmony import */ var _shared_components_popout_menu_popout_menu_component__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ../../shared/components/popout-menu/popout-menu.component */ "./src/app/shared/components/popout-menu/popout-menu.component.ts");
/* harmony import */ var _shared_components_feedback_feedback_component__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ../../shared/components/feedback/feedback.component */ "./src/app/shared/components/feedback/feedback.component.ts");
...
/* harmony import */ var _shared_directives_cdk_drop_list_scroll_container_directive__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ../../shared/directives/cdk-drop-list-scroll-container.directive */ "./src/app/shared/directives/cdk-drop-list-scroll-container.directive.ts");
/* harmony import */ var _shared_components_custom_fields_date_field_date_field_component__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ../../shared/components/custom-fields/date-field/date-field.component */ "./src/app/shared/components/custom-fields/date-field/date-field.component.ts");
/* harmony import */ var _shared_components_custom_fields_action_field_action_field_component__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ../../shared/components/custom-fields/action-field/action-field.component */ "./src/app/shared/components/custom-fields/action-field/action-field.component.ts");
/* harmony import */ var _shared_components_custom_fields_time_field_time_field_component__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ../../shared/components/custom-fields/time-field/time-field.component */ "./src/app/shared/components/custom-fields/time-field/time-field.component.ts");
/* harmony import */ var _shared_components_custom_fields_duration_field_duration_field_component__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ../../shared/components/custom-fields/duration-field/duration-field.component */ "./src/app/shared/components/custom-fields/duration-field/duration-field.component.ts");
/* harmony import */ var _shared_components_custom_fields_user_search_field_user_search_field_component__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ../../shared/components/custom-fields/user-search-field/user-search-field.component */ "./src/app/shared/components/custom-fields/user-search-field/user-search-field.component.ts");
/* harmony import */ var _shared_components_custom_fields_user_list_field_user_list_field_component__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! ../../shared/components/custom-fields/user-list-field/user-list-field.component */ "./src/app/shared/components/custom-fields/user-list-field/user-list-field.component.ts");
/* harmony import */ var _shared_components_custom_fields_counter_counter_component__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! ../../shared/components/custom-fields/counter/counter.component */ "./src/app/shared/components/custom-fields/counter/counter.component.ts");
...
/* harmony import */ var _angular_cdk_text_field__WEBPACK_IMPORTED_MODULE_35__ = __webpack_require__(/*! @angular/cdk/text-field */ "./node_modules/@angular/cdk/__ivy_ngcc__/fesm2015/text-field.js");
...
/* harmony import */ var _angular_material_core__WEBPACK_IMPORTED_MODULE_40__ = __webpack_require__(/*! @angular/material/core */ "./node_modules/@angular/material/__ivy_ngcc__/fesm2015/core.js");
...
/* harmony import */ var _angular_material_chips__WEBPACK_IMPORTED_MODULE_42__ = __webpack_require__(/*! @angular/material/chips */ "./node_modules/@angular/material/__ivy_ngcc__/fesm2015/chips.js");
/* harmony import */ var _angular_material_menu__WEBPACK_IMPORTED_MODULE_43__ = __webpack_require__(/*! @angular/material/menu */ "./node_modules/@angular/material/__ivy_ngcc__/fesm2015/menu.js");
/* harmony import */ var _angular_material_checkbox__WEBPACK_IMPORTED_MODULE_44__ = __webpack_require__(/*! @angular/material/checkbox */ "./node_modules/@angular/material/__ivy_ngcc__/fesm2015/checkbox.js");
...
/* harmony import */ var _angular_material_radio__WEBPACK_IMPORTED_MODULE_46__ = __webpack_require__(/*! @angular/material/radio */ "./node_modules/@angular/material/__ivy_ngcc__/fesm2015/radio.js");
/* harmony import */ var _angular_material_tabs__WEBPACK_IMPORTED_MODULE_47__ = __webpack_require__(/*! @angular/material/tabs */ "./node_modules/@angular/material/__ivy_ngcc__/fesm2015/tabs.js");
...
/* harmony import */ var _angular_cdk_drag_drop__WEBPACK_IMPORTED_MODULE_50__ = __webpack_require__(/*! @angular/cdk/drag-drop */ "./node_modules/@angular/cdk/__ivy_ngcc__/fesm2015/drag-drop.js");
/* harmony import */ var _angular_cdk_table__WEBPACK_IMPORTED_MODULE_51__ = __webpack_require__(/*! @angular/cdk/table */ "./node_modules/@angular/cdk/__ivy_ngcc__/fesm2015/table.js");
/* harmony import */ var _acaprojects_ngx_pipes__WEBPACK_IMPORTED_MODULE_52__ = __webpack_require__(/*! @acaprojects/ngx-pipes */ "./node_modules/@acaprojects/ngx-pipes/__ivy_ngcc__/fesm2015/acaprojects-ngx-pipes.js");
...
const ROUTES = [
    { path: '', component: _reports_component__WEBPACK_IMPORTED_MODULE_4__["ReportsComponent"] },
    { path: ':report', component: _reports_component__WEBPACK_IMPORTED_MODULE_4__["ReportsComponent"] },
    { path: '**', redirectTo: '' }
];
class ReportsModule {
}
ReportsModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({ type: ReportsModule });
ReportsModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({ factory: function ReportsModule_Factory(t) { return new (t || ReportsModule)(); }, imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterModule"].forChild(ROUTES), src_app_shared_shared_module__WEBPACK_IMPORTED_MODULE_5__["SharedContentModule"]]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](ReportsModule, { declarations: [_reports_component__WEBPACK_IMPORTED_MODULE_4__["ReportsComponent"], _report_display_report_display_component__WEBPACK_IMPORTED_MODULE_6__["ReportDisplayComponent"], _report_table_report_table_component__WEBPACK_IMPORTED_MODULE_7__["ReportTableComponent"]], imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterModule"], src_app_shared_shared_module__WEBPACK_IMPORTED_MODULE_5__["SharedContentModule"]] }); })();
...
//# sourceMappingURL=shell-reports-reports-module-es2015.js.map