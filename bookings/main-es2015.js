...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _acaprojects_ngx_overlays__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @acaprojects/ngx-overlays */ "./node_modules/@acaprojects/ngx-overlays/fesm2015/acaprojects-ngx-overlays.js");
...
/* harmony import */ var _services_data_bookings_booking_class__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../services/data/bookings/booking.class */ "./src/app/services/data/bookings/booking.class.ts");
/* harmony import */ var _shared_globals_overlay_register__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../shared/globals/overlay-register */ "./src/app/shared/globals/overlay-register.ts");
...
class BookingModalComponent extends _shared_base_component__WEBPACK_IMPORTED_MODULE_3__["BaseComponent"] {
    ...
    ngOnInit() {
        this.booking = new _services_data_bookings_booking_class__WEBPACK_IMPORTED_MODULE_4__["Booking"](this.service.Bookings, {
        ...
        if (date_field) {
            date_field.setValue(this.item.data.date || dayjs__WEBPACK_IMPORTED_MODULE_6__().valueOf());
        }
...
_shared_globals_overlay_register__WEBPACK_IMPORTED_MODULE_5__["OVERLAY_REGISTER"].push({
    id: 'booking',
...
class ConfirmModalComponent extends _shared_base_component__WEBPACK_IMPORTED_MODULE_2__["BaseComponent"] {
    constructor(item) {
        super();
        this.item = item;
    }
...
_shared_globals_overlay_register__WEBPACK_IMPORTED_MODULE_3__["OVERLAY_REGISTER"].push({ id: 'confirm', config: { content: ConfirmModalComponent, config: 'modal' } });
...
class EmbeddedControlModalComponent extends _shared_base_component__WEBPACK_IMPORTED_MODULE_2__["BaseComponent"] {
    constructor(item) {
        super();
        this.item = item;
        this.countdown = 30;
...
_shared_globals_overlay_register__WEBPACK_IMPORTED_MODULE_3__["OVERLAY_REGISTER"].push({ id: 'embeded-control', config: { content: EmbeddedControlModalComponent, config: 'modal' } });
...
class BaseDataClass extends _shared_base_class__WEBPACK_IMPORTED_MODULE_2__["BaseClass"] {
     ...
     */
    duplicate() {
        return new BaseDataClass(this.service, Object.assign({}, this, { id: null, email: null }));
    }
    /**
...
class BaseAPIService extends _shared_base_class__WEBPACK_IMPORTED_MODULE_2__["BaseClass"] {
    ...
    task(id, task_name, form_data = {}) {
        ...
        if (!this._promises[key]) {
            this._promises[key] = new Promise((resolve, reject) => {
                const post_data = Object.assign({}, form_data, { id, _task: task_name });
    ...
    poll(id, query_params = {}, delay = 5000) {
        ...
        const query = Object.assign({}, (query_params || {}), { _poll: true });
        if (id) {
...
class Booking extends _base_api_class__WEBPACK_IMPORTED_MODULE_3__["BaseDataClass"] {
    ...
    initialiseFormFields() {
        ...
        const process_field = field => {
            const f = {
                ...
                hide: field.hide,
                metadata: Object.assign({}, field.metadata, this._form_metadata, { service: this.service }),
     ...
     */
    duplicate() {
        return new Booking(this.service, Object.assign({}, this, { id: null, email: null, icaluid: null }));
    }
}
...
class OrganisationService extends _base_service__WEBPACK_IMPORTED_MODULE_2__["BaseAPIService"] {
    constructor(_composer) {
        super(_composer);
        this._composer = _composer;
    ...
    loadOrganisation() {
        return new Promise((resolve) => {
            this.query({ tags: 'org', engine: true }).then((org_data) => {
                this._organisation = new _organisation_class__WEBPACK_IMPORTED_MODULE_3__["Organisation"](this, org_data[0]);
    ...
    loadBuildings() {
        return new Promise((resolve) => {
            this.query({ tags: 'building', engine: true }).then((bld_data) => {
                const buildings = bld_data.map(i => new _building_class__WEBPACK_IMPORTED_MODULE_4__["Building"](this, i));
...
class Space extends _base_api_class__WEBPACK_IMPORTED_MODULE_0__["BaseDataClass"] {
    ...
    isAvailable(options) {
        options = options
            ? Object.assign({}, OPTION_DEFAULTS, options, { room_ids: this.id }) : Object.assign({}, OPTION_DEFAULTS, { room_ids: this.id });
        return new Promise((resolve) => {
     ...
     */
    duplicate() {
        return new Space(this.service, Object.assign({}, this, { id: null, email: null, _bookings: [] }));
    }
}
...
SpacesService.ngInjectableDef = _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdefineInjectable"]({ factory: function SpacesService_Factory() { return new SpacesService(_angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵinject"](_acaprojects_ngx_composer__WEBPACK_IMPORTED_MODULE_0__["ComposerService"])); }, token: SpacesService, providedIn: "root" });
...
SystemsManagerService.ngInjectableDef = _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineInjectable"]({ factory: function SystemsManagerService_Factory() { return new SystemsManagerService(_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵinject"](_acaprojects_ngx_composer__WEBPACK_IMPORTED_MODULE_0__["ComposerService"])); }, token: SystemsManagerService, providedIn: "root" });
...
class User extends _base_api_class__WEBPACK_IMPORTED_MODULE_1__["BaseDataClass"] {
     ...
     */
    duplicate() {
        return new User(this.service, Object.assign({}, this, { id: null, email: null }));
    }
    /**
     * Initialise the form field metadata for the field
     */
...
class SettingsService extends _shared_base_class__WEBPACK_IMPORTED_MODULE_5__["BaseClass"] {
    constructor(http) {
        super();
        this.http = http;
        /** Map of settings */
        ...
        const built = now.isSame(_shared_globals_application__WEBPACK_IMPORTED_MODULE_3__["build"], 'd') ? `Today at ${_shared_globals_application__WEBPACK_IMPORTED_MODULE_3__["build"].format('h:mmA')}` : _shared_globals_application__WEBPACK_IMPORTED_MODULE_3__["build"].format('D MMM YYYY, h:mmA');
        this.log('CORE', `${_shared_globals_application__WEBPACK_IMPORTED_MODULE_3__["core_version"]}`, null, 'debug', true);
        this.log('APP', `${_shared_globals_application__WEBPACK_IMPORTED_MODULE_3__["version"]} | Built: ${built}`, null, 'debug', true);
        this.init();
    }
    /**
            ...
            if (!this._promises[key]) {
                this._promises[key] = new Promise((resolve, reject) => {
                    this.http.get(file).subscribe((data) => {
                        this._settings[name] = Object.assign({}, (this._settings[name] || {}), (data || {}));
                    }, (e) => {
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _base_class__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./base.class */ "./src/app/shared/base.class.ts");
...
/* harmony import */ var _base_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../base.component */ "./src/app/shared/base.component.ts");
...
/* harmony import */ var _utilities_general_utilities__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../utilities/general.utilities */ "./src/app/shared/utilities/general.utilities.ts");
/* harmony import */ var _globals_form_fields__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../globals/form-fields */ "./src/app/shared/globals/form-fields.ts");
...
class CustomUserSearchFieldComponent extends _base_component__WEBPACK_IMPORTED_MODULE_5__["BaseComponent"] {
    ...
    ngOnInit() {
        ...
        this.search_results$ = this.search$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["debounceTime"])(400), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["distinctUntilChanged"])(), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(query => {
            ...
            return Object(_utilities_general_utilities__WEBPACK_IMPORTED_MODULE_7__["filterList"])(this.search_str, list, ['name', 'email']);
        }));
        // Process API results
        this.search_results$.subscribe(list => {
            this.filtered_list = list;
            this.filtered_list.forEach((i) => {
                i.match_name = Object(_utilities_general_utilities__WEBPACK_IMPORTED_MODULE_7__["matchToHighlight"])(i.match_name);
                i.match_email = Object(_utilities_general_utilities__WEBPACK_IMPORTED_MODULE_7__["matchToHighlight"])(i.match_email);
                return i;
            });
        });
    }
...
_globals_form_fields__WEBPACK_IMPORTED_MODULE_8__["FORM_FIELDS"].host = CustomUserSearchFieldComponent;
...
function createSystem() {
    ...
    system.Bookings.push(Object.assign({}, bindings, { room_name: space.name, today: space.bookings, reload: dayjs__WEBPACK_IMPORTED_MODULE_3__().add(1, 'h').unix(), $start_meeting: (time) => {
...
class BootstrapComponent extends _shared_base_component__WEBPACK_IMPORTED_MODULE_3__["BaseComponent"] {
...
class BookingPanelArrayComponent extends _shared_base_component__WEBPACK_IMPORTED_MODULE_2__["BaseComponent"] {
    ...
    get time() {
        return dayjs__WEBPACK_IMPORTED_MODULE_4__().format('h:mm:ss A');
    }
    ngOnInit() {
...
class BookingPanelSelectComponent extends _shared_base_component__WEBPACK_IMPORTED_MODULE_1__["BaseComponent"] {
    ...
    updateStatus(id, bookings) {
        const space = new _services_data_spaces_space_class__WEBPACK_IMPORTED_MODULE_3__["Space"](this.service.Spaces, { id, bookings });
...
class BookingPanelComponent extends _shared_base_component__WEBPACK_IMPORTED_MODULE_3__["BaseComponent"] {
    ...
    get display_time() {
        return dayjs__WEBPACK_IMPORTED_MODULE_6__().format('h:mm A');
    }
    ngOnInit() {
        this.subscription('app_ready', this._service.initialised.subscribe((is_ready) => {
            if (is_ready) {
    ...
    updateBookings(bookings) {
        this.space = new _services_data_spaces_space_class__WEBPACK_IMPORTED_MODULE_4__["Space"](this._service.Spaces, {
            id: this.system_id,
        ...
        if (this.hide_all) {
            ...
            if (this.space && (this.space.current || this.space.next)) {
                ...
                if (this.pending_timeout) {
                    ...
                    const date = dayjs__WEBPACK_IMPORTED_MODULE_6__(booking.date).startOf('m');
                    if (this.last_started >= now.valueOf() || this.last_started >= date.valueOf()) {
                        ...
                        if (now.isAfter(pending_start, 's') && now.isBefore(pending_end, 's')) {
                            ...
                            this._status = 'pending';
                            const business_start = dayjs__WEBPACK_IMPORTED_MODULE_6__(Object(_shared_utilities_general_utilities__WEBPACK_IMPORTED_MODULE_5__["timeToDate"])(this.business_start || '08:00'));
                            const business_end = dayjs__WEBPACK_IMPORTED_MODULE_6__(Object(_shared_utilities_general_utilities__WEBPACK_IMPORTED_MODULE_5__["timeToDate"])(this.business_end || '17:30'));
    ...
    endMeeting(reason = 'user_input') {
        if (this.space && this.can_cancel !== false) {
            ...
            if (meeting && module && meeting.date !== this.last_cancel) {
                const date = dayjs__WEBPACK_IMPORTED_MODULE_6__(meeting.date);
                module.exec('cancel_meeting', [meeting.date, reason]).then(_ => {
...
/* harmony import */ var _shared_globals_application__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../shared/globals/application */ "./src/app/shared/globals/application.ts");
...
class ShellWrapperComponent extends _shared_base_component__WEBPACK_IMPORTED_MODULE_2__["BaseComponent"] {
    ...
    get version() {
        return _shared_globals_application__WEBPACK_IMPORTED_MODULE_4__["version"];
    }
    /** Current version of the application */
    get build() {
        const now = dayjs__WEBPACK_IMPORTED_MODULE_5__();
        const built = _shared_globals_application__WEBPACK_IMPORTED_MODULE_4__["build"].format('DD/MM/YY HH:mm');
        return built;
    }
    get show_version() {
    ...
    reloadAt(time) {
        if (time && typeof time === 'number') {
            ...
            const reload_at_time = dayjs__WEBPACK_IMPORTED_MODULE_5__((time || 0) * 1000).startOf('s');
