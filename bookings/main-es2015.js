...
class ApplicationService extends _shared_base_class__WEBPACK_IMPORTED_MODULE_9__["BaseClass"] {
    ...
    init() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            yield Promise.race([
                Object(rxjs__WEBPACK_IMPORTED_MODULE_8__["timer"])(Math.floor(Math.random() * 15 * 1000 / 25) * 25).toPromise(),
...
function View_BookingPanelComponent_15(_l) { return _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵvid"](0, [(_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](0, 0, null, null, 1, "button", [["class", "absolute bottom-2 right-2"], ["mat-button", ""]], null, [[null, "click"]], function (_v, en, $event) { var ad = true; var _co = _v.component; if (("click" === en)) {
 ...
 * tslint:disable
 */ 
var styles = ["\n\n\n\n.dropdown[widget] {\n  border-radius: 4px;\n}\n.dropdown[widget].fill {\n  width: 100%;\n}\n.dropdown-list[widget] {\n  border-radius: 4px;\n}\n.spinner svg {\n  width: 100%;\n}\nbutton[widget] {\n  outline: none;\n}\nbutton[widget].default {\n  background-color: #1f40e6;\n}\nbutton[widget].action {\n  height: 2em;\n  width: 2em;\n  border-radius: 100%;\n  background-color: #fff;\n  color: rgba(0, 0, 0, 0.87);\n  border: 2px solid rgba(0, 0, 0, 0.87);\n  box-shadow: 0 0 0 2px #fff;\n  font-size: 1.5em;\n}\nbutton[widget].action:hover {\n  box-shadow: 0 0 0 2px rgba(255, 255, 255, 0.6);\n}\nbutton[widget].action .wrapper {\n  height: 100%;\n  padding: 0;\n  align-items: center;\n  justify-content: center;\n  flex-direction: column;\n  width: 100%;\n}\nbutton[widget][disabled] {\n  background-color: #ccc;\n  pointer-events: none;\n}\n.dropdown[widget].default {\n  width: 9.5em;\n}\n.dynamic-form[widget] .error input {\n  border-color: #ae1928;\n}\n.dynamic-form[widget] .dynamic-field .info.status {\n  margin: 0;\n  padding: 0;\n}\n.dynamic-field[widget] .details {\n  min-width: 100%;\n}\n.dynamic-field[widget] label {\n  margin-left: 0;\n}\n.dynamic-field[widget] .control {\n  min-width: 10em;\n}\n.overlay-backdrop {\n  background-color: rgba(0, 0, 0, 0.6);\n}\n.modal[widget] {\n  display: flex;\n  align-items: center;\n  flex-direction: column;\n  background-color: #fff;\n  border-radius: 4px;\n  overflow: hidden;\n  box-shadow: 0 1px 3px 0 rgba(0, 0, 0, 0.2), 0 1px 1px 0 rgba(0, 0, 0, 0.14), 0 2px 1px -1px rgba(0, 0, 0, 0.12);\n  max-width: 95vw;\n  max-height: 90vh;\n}\n.modal[widget] > .header {\n  width: 100%;\n  display: flex;\n  align-items: center;\n  height: 2.5em;\n  background-color: #f0f0f0;\n}\n.modal[widget] > .header .text {\n  padding: 0.75em;\n  min-width: 10em;\n  flex: 1;\n  font-weight: 500;\n}\n.modal[widget] > .header .close {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  height: 100%;\n  width: 1.8em;\n  font-size: 1.25em;\n}\n.modal[widget] > .body {\n  width: 100%;\n  min-height: 4em;\n  flex: 1;\n  overflow: auto;\n  padding: 0.5em;\n}\n.modal[widget] > .footer {\n  width: 100%;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  border-top: 1px solid #ccc;\n}\n.modal[widget] > .footer button {\n  min-width: 6em;\n}\n.notification[widget] .content > .text {\n  display: flex;\n  align-items: center;\n}\n.notification[widget] .icon {\n  height: 1.25em;\n  width: 1.25em;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  font-size: 2em;\n  margin-right: 0.3em;\n}\n.notification[widget] .action {\n  margin: 0 0.5em;\n}\n.notification[widget] .action .icon {\n  background: none;\n  margin: 0;\n}\n.notification[widget] .action .icon:after {\n  font-family: \"Material Icons\";\n  content: \"close\";\n}\n.notification[widget].error .item {\n  background-color: #ae1928 !important;\n  color: #fff;\n}\n.notification[widget].error .item i:after {\n  content: \"error\";\n}\n.notification[widget].warn .item {\n  background-color: #ffD048 !important;\n  color: #fff;\n}\n.notification[widget].warn .item i:after {\n  content: \"warning\";\n}\n.notification[widget].info .item {\n  background-color: #fff !important;\n  color: #fff;\n}\n.notification[widget].info .item i:after {\n  content: \"info\";\n}\n.notification[widget].success .item {\n  background-color: #3aa537 !important;\n  color: #fff;\n}\n.notification[widget].success .item i:after {\n  content: \"done\";\n}\n.relative {\n  position: relative;\n}\n.absolute {\n  position: absolute;\n}\n.bottom-2 {\n  bottom: 0.5rem;\n}\n.right-2 {\n  right: 0.5rem;\n}\n/*# sourceMappingURL=data:application/json;base64, */"];
