...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppServicesSettingsServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _shared_base_class__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ../shared/base.class */
    "./src/app/shared/base.class.ts");
    /* harmony import */
    ...
    var SettingsService = /*#__PURE__*/function (_shared_base_class__W5) {
      ...
      function SettingsService(http) {
        ...
        _this57._app_name = 'ACA';
        var now = dayjs__WEBPACK_IMPORTED_MODULE_4__();
        var built = now.isSame(_shared_globals_application__WEBPACK_IMPORTED_MODULE_3__["build"], 'd') ? "Today at ".concat(_shared_globals_application__WEBPACK_IMPORTED_MODULE_3__["build"].format('h:mmA')) : _shared_globals_application__WEBPACK_IMPORTED_MODULE_3__["build"].format('D MMM YYYY, h:mmA');

        _this57.log('CORE', "".concat(_shared_globals_application__WEBPACK_IMPORTED_MODULE_3__["core_version"]), null, 'debug', true);

        _this57.log('APP', "".concat(_shared_globals_application__WEBPACK_IMPORTED_MODULE_3__["version"], " | Built: ").concat(built), null, 'debug', true);
