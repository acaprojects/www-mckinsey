...
function ExploreSearchComponent_mat_option_3_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](2);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate1"]("", option_r10.level ? option_r10.level.name : option_r10.email, "\u00A0");
} }
...
class ExploreSearchComponent extends src_app_shared_base_directive__WEBPACK_IMPORTED_MODULE_4__["BaseDirective"] {
    ...
    ngOnInit() {
        this._spaces.initialised.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["first"])(_ => _)).subscribe(() => {
            ...
            this.search_results$ = this.search$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["debounceTime"])(300), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["distinctUntilChanged"])(), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["switchMap"])(query => {
                this.loading = true;
            ...
            this.search$.next(`${dayjs__WEBPACK_IMPORTED_MODULE_8__().valueOf()}`);
        });
    }
    ngOnChanges(changes) {
        /* istanbul ignore else */
