...
/* harmony import */ var src_app_services_data_users_user_class__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! src/app/services/data/users/user.class */ "./src/app/services/data/users/user.class.ts");
/* harmony import */ var src_app_services_data_users_users_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! src/app/services/data/users/users.service */ "./src/app/services/data/users/users.service.ts");
/* harmony import */ var src_app_services_data_bookings_bookings_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! src/app/services/data/bookings/bookings.service */ "./src/app/services/data/bookings/bookings.service.ts");
...
/* harmony import */ var _acaprojects_ngx_date_picker__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! @acaprojects/ngx-date-picker */ "./node_modules/@acaprojects/ngx-date-picker/__ivy_ngcc__/fesm2015/acaprojects-ngx-date-picker.js");
...
/* harmony import */ var _list_item_list_item_component__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./list-item/list-item.component */ "./src/app/shell/schedule/event-list/list-item/list-item.component.ts");
...
function ScheduleEventListComponent_mat_form_field_3_mat_option_3_Template(rf, ctx) { if (rf & 1) {
...
function ScheduleEventListComponent_mat_form_field_3_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("valueChange", function ScheduleEventListComponent_mat_form_field_3_Template_mat_select_valueChange_1_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r8); const ctx_r7 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r7.active_user = $event; })("valueChange", function ScheduleEventListComponent_mat_form_field_3_Template_mat_select_valueChange_1_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r8); const ctx_r9 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r9.updateEvents($event); });
...
function ScheduleEventListComponent_mat_progress_bar_9_Template(rf, ctx) { if (rf & 1) {
...
const _c0 = function () { return { class: "material-icons", content: "event" }; };
class ScheduleEventListComponent extends src_app_shared_base_directive__WEBPACK_IMPORTED_MODULE_6__["BaseDirective"] {
    constructor(_users, _bookings, _spaces, _route) {
        super();
        this._users = _users;
        ...
        this._route = _route;
        /** Emitter  */
        this.event_list = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"]();
        ...
        this.date_offset = 0;
        /** Current UTC epoch */
        this.now = dayjs__WEBPACK_IMPORTED_MODULE_11__().valueOf();
                ...
                if (params.has('email')) {
                    this.active_user =
                        this._users.find(params.get('email')) ||
                            new src_app_services_data_users_user_class__WEBPACK_IMPORTED_MODULE_7__["User"]({ email: params.get('email') });
                }
            }));
            this.updateEvents();
            this.interval('update_events', () => this.updateEvents(), 10 * 1000);
            this.subscription('scroll', this.scroll_viewport.elementScrolled().subscribe(() => this.onScroll()));
            this.subscription('delegate_list', this._users.listen('delegates').subscribe((list) => {
                /* istanbul ignore else */
                if (list && list[0]) {
    ...
    updateEvents() {
        ...
        if (!this.event_promise) {
            this.event_promise = new Promise((resolve) => {
                const start = dayjs__WEBPACK_IMPORTED_MODULE_11__().add(this.date_offset, 'd').startOf('d');
                ...
                this._bookings
                    ...
                    const old_events = this.events.filter((i) => {
                        const date = dayjs__WEBPACK_IMPORTED_MODULE_11__(i.date);
                        return (i.type !== 'date' &&
                            i.type !== 'empty' &&
    ...
    processEvents(list, old_events) {
        let events = [];
        const now = dayjs__WEBPACK_IMPORTED_MODULE_11__();
        let date = dayjs__WEBPACK_IMPORTED_MODULE_11__().startOf('d');
        ...
        for (; date.isBefore(end); date = date.add(1, 'd')) {
            ...
            const filter_fn = (i) => {
                const day = dayjs__WEBPACK_IMPORTED_MODULE_11__(i.date);
        ...
        events = Object(src_app_shared_utilities_general_utilities__WEBPACK_IMPORTED_MODULE_5__["unique"])(events, 'id');
        return events;
    }
    /**
    ...
    onScroll() {
        ...
        if (!this.event_promise) {
            ...
            this.date_offset = dayjs__WEBPACK_IMPORTED_MODULE_11__(nearest.date).diff(dayjs__WEBPACK_IMPORTED_MODULE_11__(), 'd') - 1;
            this.date = dayjs__WEBPACK_IMPORTED_MODULE_11__((this.events[dist + range.start] || {}).date)
                .subtract(1, 'd')
                .valueOf();
            /* istanbul ignore else */
     ...
     */
    updateDate(date) {
        const day = dayjs__WEBPACK_IMPORTED_MODULE_11__(date);
        this.date_offset = day.diff(dayjs__WEBPACK_IMPORTED_MODULE_11__(), 'd') - 1;
        this.shown_offset = Math.max(this.shown_offset, this.date_offset + 3);
        this.scroll_to = day.format('YYYY-MM-DD');
        delete this.event_promise;
        this.show_calendar = false;
        this.date = dayjs__WEBPACK_IMPORTED_MODULE_11__().add(this.date_offset, 'd').valueOf();
        this.updateEvents();
    }
...
ScheduleEventListComponent.ɵfac = function ScheduleEventListComponent_Factory(t) { return new (t || ScheduleEventListComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_services_data_users_users_service__WEBPACK_IMPORTED_MODULE_8__["UsersService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_services_data_bookings_bookings_service__WEBPACK_IMPORTED_MODULE_9__["BookingsService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_services_data_spaces_spaces_service__WEBPACK_IMPORTED_MODULE_10__["SpacesService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_1__["ActivatedRoute"])); };
ScheduleEventListComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ScheduleEventListComponent, selectors: [["schedule-event-list"]], viewQuery: function ScheduleEventListComponent_Query(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵstaticViewQuery"](_angular_cdk_scrolling__WEBPACK_IMPORTED_MODULE_3__["CdkVirtualScrollViewport"], true);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵstaticViewQuery"](_angular_material_menu__WEBPACK_IMPORTED_MODULE_2__["MatMenuTrigger"], true);
    } if (rf & 2) {
        var _t;
    ...
    } }, outputs: { event_list: "eventList" }, features: [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵInheritDefinitionFeature"]], decls: 18, vars: 10, consts: [[1, "event-list"], [1, "header", "dark-mode"], [1, "user"], ["appearance", "outline", 4, "ngIf"], [1, "flex"], [1, "date"], ["mat-icon-button", "", 3, "matMenuTriggerFor"], [3, "icon"], [1, "progress"], ["mode", "indeterminate", 4, "ngIf"], [1, "body"], ["itemSize", "80", 1, "viewport", 3, "scroll"], [4, "cdkVirtualFor", "cdkVirtualForOf", "cdkVirtualForTrackBy"], [1, "footer"], ["appMenu", "matMenu"], ["mat-menu-item", "", 1, "date-picker", 3, "click"], [3, "ngModel", "ngModelChange"], ["appearance", "outline"], [3, "value", "valueChange"], ["select", ""], [3, "value", 4, "ngFor", "ngForOf"], [3, "value"], ["mode", "indeterminate"], [3, "user", "event"]], template: function ScheduleEventListComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("scroll", function ScheduleEventListComponent_Template_cdk_virtual_scroll_viewport_scroll_11_listener() { return ctx.onScroll(); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ScheduleEventListComponent_Template_div_click_16_listener($event) { return $event.stopPropagation(); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](17, "a-date-picker", 16);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function ScheduleEventListComponent_Template_a_date_picker_ngModelChange_17_listener($event) { return ctx.date = $event; })("ngModelChange", function ScheduleEventListComponent_Template_a_date_picker_ngModelChange_17_listener($event) { ctx.updateDate($event); return ctx.closeDatePicker(); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    } if (rf & 2) {
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ScheduleEventListComponent, [{
    ...
    }], function () { return [{ type: src_app_services_data_users_users_service__WEBPACK_IMPORTED_MODULE_8__["UsersService"] }, { type: src_app_services_data_bookings_bookings_service__WEBPACK_IMPORTED_MODULE_9__["BookingsService"] }, { type: src_app_services_data_spaces_spaces_service__WEBPACK_IMPORTED_MODULE_10__["SpacesService"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_1__["ActivatedRoute"] }]; }, { event_list: [{
            type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"],
            args: ['eventList']
        }], scroll_viewport: [{
            type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"],
            args: [_angular_cdk_scrolling__WEBPACK_IMPORTED_MODULE_3__["CdkVirtualScrollViewport"], { static: true }]
        }], trigger: [{
            type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"],
            args: [_angular_material_menu__WEBPACK_IMPORTED_MODULE_2__["MatMenuTrigger"], { static: true }]
        }] }); })();
...
/* harmony import */ var src_app_overlays_meeting_details_overlay_meeting_details_overlay_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/overlays/meeting-details-overlay/meeting-details-overlay.component */ "./src/app/overlays/meeting-details-overlay/meeting-details-overlay.component.ts");
/* harmony import */ var src_app_services_data_users_user_class__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/app/services/data/users/user.class */ "./src/app/services/data/users/user.class.ts");
...
function ScheduleEventListItemComponent_div_0_div_4_div_6_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 19);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1, "In Progress");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} }
function ScheduleEventListItemComponent_div_0_div_4_Template(rf, ctx) { if (rf & 1) {
    const _r6 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 7);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "a", 8);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("tapped", function ScheduleEventListItemComponent_div_0_div_4_Template_a_tapped_1_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r6); const ctx_r5 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](2); return ctx_r5.openDetailsModal(); });
...
class ScheduleEventListItemComponent extends src_app_shared_base_directive__WEBPACK_IMPORTED_MODULE_2__["BaseDirective"] {
    constructor(_dialog, _users) {
        super();
    ...
    get date_display() {
        const date = dayjs__WEBPACK_IMPORTED_MODULE_6__(this.event.date);
    ...
    get time() {
        ...
        return booking.all_day || booking.duration > 23 * 60
            ? 'All Day'
            : dayjs__WEBPACK_IMPORTED_MODULE_6__(booking.date).format('h:mm A');
    }
...
ScheduleEventListItemComponent.ɵfac = function ScheduleEventListItemComponent_Factory(t) { return new (t || ScheduleEventListItemComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_material_dialog__WEBPACK_IMPORTED_MODULE_1__["MatDialog"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_services_data_users_users_service__WEBPACK_IMPORTED_MODULE_7__["UsersService"])); };
ScheduleEventListItemComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ScheduleEventListItemComponent, selectors: [["schedule-event-item"]], inputs: { event: "event", user: "user" }, features: [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵInheritDefinitionFeature"]], decls: 1, vars: 1, consts: [[3, "class", 4, "ngIf"], [3, "ngSwitch"], ["class", "day display", 4, "ngSwitchCase"], ["class", "emptied display", 4, "ngSwitchCase"], ["class", "event display", 4, "ngSwitchDefault"], [1, "day", "display"], [1, "emptied", "display"], [1, "event", "display"], [3, "tapped"], [1, "content"], [1, "time"], ["class", "info", 4, "ngIf"], [1, "icon"], [3, "src"], [1, "details"], [1, "title", "text"], [1, "location", "text"], ["src", "assets/img/location.svg"], [1, "text"], [1, "info"]], template: function ScheduleEventListItemComponent_Template(rf, ctx) { if (rf & 1) {
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ScheduleEventListItemComponent, [{
    ...
    }], function () { return [{ type: _angular_material_dialog__WEBPACK_IMPORTED_MODULE_1__["MatDialog"] }, { type: src_app_services_data_users_users_service__WEBPACK_IMPORTED_MODULE_7__["UsersService"] }]; }, { event: [{
...
/* harmony import */ var _shared_components_footer_menu_footer_menu_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../shared/components/footer-menu/footer-menu.component */ "./src/app/shared/components/footer-menu/footer-menu.component.ts");
/* harmony import */ var _shared_components_overlay_menu_overlay_menu_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../shared/components/overlay-menu/overlay-menu.component */ "./src/app/shared/components/overlay-menu/overlay-menu.component.ts");
/* harmony import */ var _view_event_view_event_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./view-event/view-event.component */ "./src/app/shell/schedule/view-event/view-event.component.ts");
/* harmony import */ var _event_list_event_list_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./event-list/event-list.component */ "./src/app/shell/schedule/event-list/event-list.component.ts");
...
function ScheduleComponent_ng_container_5_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerStart"](0);
...
function ScheduleComponent_ng_container_6_Template(rf, ctx) { if (rf & 1) {
    const _r3 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerStart"](0);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "schedule-event-list", 10);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("eventList", function ScheduleComponent_ng_container_6_Template_schedule_event_list_eventList_1_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r3); const ctx_r2 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r2.updateEvents($event); });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerEnd"]();
} }
class ScheduleComponent extends src_app_shared_base_directive__WEBPACK_IMPORTED_MODULE_2__["BaseDirective"] {
...
ScheduleComponent.ɵfac = function ScheduleComponent_Factory(t) { return new (t || ScheduleComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_1__["ActivatedRoute"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_services_app_service__WEBPACK_IMPORTED_MODULE_3__["ApplicationService"])); };
ScheduleComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ScheduleComponent, selectors: [["app-schedule"]], features: [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵInheritDefinitionFeature"]], decls: 10, vars: 4, consts: [[1, "schedule", "page"], [1, "header"], [3, "menu", "menuChange"], [1, "body"], [3, "ngSwitch"], [4, "ngSwitchCase"], [4, "ngSwitchDefault"], [1, "footer"], [3, "show", "showChange"], [3, "id", "next", "previous"], [3, "eventList"]], template: function ScheduleComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "header", 1);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](2, "a-topbar-header", 2);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("menuChange", function ScheduleComponent_Template_a_topbar_header_menuChange_2_listener($event) { return ctx.show_menu = $event; });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("showChange", function ScheduleComponent_Template_a_overlay_menu_showChange_9_listener($event) { return ctx.show_menu = $event; });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    } if (rf & 2) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](2);
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ScheduleComponent, [{
    ...
    }], function () { return [{ type: _angular_router__WEBPACK_IMPORTED_MODULE_1__["ActivatedRoute"] }, { type: src_app_services_app_service__WEBPACK_IMPORTED_MODULE_3__["ApplicationService"] }]; }, null); })();
...
/* harmony import */ var _placeos_composer__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @placeos/composer */ "./node_modules/@placeos/composer/__ivy_ngcc__/fesm2015/placeos-composer.js");
/* harmony import */ var _schedule_routes__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./schedule.routes */ "./src/app/shell/schedule/schedule.routes.ts");
/* harmony import */ var src_app_shared_shared_module__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! src/app/shared/shared.module */ "./src/app/shared/shared.module.ts");
/* harmony import */ var _schedule_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./schedule.component */ "./src/app/shell/schedule/schedule.component.ts");
/* harmony import */ var _event_list_event_list_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./event-list/event-list.component */ "./src/app/shell/schedule/event-list/event-list.component.ts");
/* harmony import */ var _view_event_view_event_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./view-event/view-event.component */ "./src/app/shell/schedule/view-event/view-event.component.ts");
/* harmony import */ var _event_list_list_item_list_item_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./event-list/list-item/list-item.component */ "./src/app/shell/schedule/event-list/list-item/list-item.component.ts");
/* harmony import */ var _view_event_event_details_event_details_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./view-event/event-details/event-details.component */ "./src/app/shell/schedule/view-event/event-details/event-details.component.ts");
/* harmony import */ var _view_event_event_edit_event_edit_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./view-event/event-edit/event-edit.component */ "./src/app/shell/schedule/view-event/event-edit/event-edit.component.ts");
...
ScheduleModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({ factory: function ScheduleModule_Factory(t) { return new (t || ScheduleModule)(); }, imports: [[
            ...
            _placeos_composer__WEBPACK_IMPORTED_MODULE_5__["ComposerModule"],
            _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"],
            _angular_forms__WEBPACK_IMPORTED_MODULE_2__["ReactiveFormsModule"],
            _angular_router__WEBPACK_IMPORTED_MODULE_4__["RouterModule"].forChild(_schedule_routes__WEBPACK_IMPORTED_MODULE_6__["ROUTES"]),
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](ScheduleModule, { declarations: [_schedule_component__WEBPACK_IMPORTED_MODULE_8__["ScheduleComponent"],
        ...
        _event_list_list_item_list_item_component__WEBPACK_IMPORTED_MODULE_11__["ScheduleEventListItemComponent"],
        _view_event_event_details_event_details_component__WEBPACK_IMPORTED_MODULE_12__["EventDetailsComponent"],
        _view_event_event_edit_event_edit_component__WEBPACK_IMPORTED_MODULE_13__["EventEditComponent"]], imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"],
        _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"],
        _placeos_composer__WEBPACK_IMPORTED_MODULE_5__["ComposerModule"],
        _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"],
        _angular_forms__WEBPACK_IMPORTED_MODULE_2__["ReactiveFormsModule"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["RouterModule"], src_app_shared_shared_module__WEBPACK_IMPORTED_MODULE_7__["SharedContentModule"],
        _angular_cdk_scrolling__WEBPACK_IMPORTED_MODULE_3__["ScrollingModule"]] }); })();
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ScheduleModule, [{
        ...
        args: [{
                declarations: [
                    ...
                    _event_list_list_item_list_item_component__WEBPACK_IMPORTED_MODULE_11__["ScheduleEventListItemComponent"],
                    _view_event_event_details_event_details_component__WEBPACK_IMPORTED_MODULE_12__["EventDetailsComponent"],
                    _view_event_event_edit_event_edit_component__WEBPACK_IMPORTED_MODULE_13__["EventEditComponent"]
                ],
                imports: [
                    _angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"],
                    _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"],
...
/* harmony import */ var src_app_shared_utilities_general_utilities__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/app/shared/utilities/general.utilities */ "./src/app/shared/utilities/general.utilities.ts");
/* harmony import */ var src_app_overlays_view_room_modal_view_room_modal_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! src/app/overlays/view-room-modal/view-room-modal.component */ "./src/app/overlays/view-room-modal/view-room-modal.component.ts");
/* harmony import */ var dayjs__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! dayjs */ "./node_modules/dayjs/dayjs.min.js");
/* harmony import */ var dayjs__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(dayjs__WEBPACK_IMPORTED_MODULE_7__);
/* harmony import */ var src_app_services_data_users_users_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! src/app/services/data/users/users.service */ "./src/app/services/data/users/users.service.ts");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/__ivy_ngcc__/fesm2015/common.js");
/* harmony import */ var _placeos_composer__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @placeos/composer */ "./node_modules/@placeos/composer/__ivy_ngcc__/fesm2015/placeos-composer.js");
...
function EventDetailsComponent_ng_container_2_ng_container_1_Template(rf, ctx) { if (rf & 1) {
    const _r13 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerStart"](0);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "i", 23);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("modelChange", function EventDetailsComponent_ng_container_2_ng_container_1_Template_i_modelChange_1_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r13); const space_r10 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().$implicit; const ctx_r12 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return (ctx_r12.last_start[space_r10.id] = $event); });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](2, "i", 24);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("modelChange", function EventDetailsComponent_ng_container_2_ng_container_1_Template_i_modelChange_2_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r13); const ctx_r15 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](2); return ctx_r15.checkin = $event; });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerEnd"]();
} if (rf & 2) {
    const space_r10 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().$implicit;
...
function EventDetailsComponent_ng_container_2_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerStart"](0);
...
function EventDetailsComponent_div_24_button_4_Template(rf, ctx) { if (rf & 1) {
    const _r22 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "button", 30);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("tapped", function EventDetailsComponent_div_24_button_4_Template_button_tapped_0_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r22); const item_r17 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().$implicit; const ctx_r20 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r20.locate(item_r17); });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1, " Map ");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} }
function EventDetailsComponent_div_24_a_5_Template(rf, ctx) { if (rf & 1) {
...
function EventDetailsComponent_div_25_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 32);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1, "No Location");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} }
function EventDetailsComponent_button_26_Template(rf, ctx) { if (rf & 1) {
    const _r25 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "button", 33);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("touchrelease", function EventDetailsComponent_button_26_Template_button_touchrelease_0_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r25); const ctx_r24 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r24.show_locations = !ctx_r24.show_locations; });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} if (rf & 2) {
...
function EventDetailsComponent_div_37_div_5_Template(rf, ctx) { if (rf & 1) {
...
function EventDetailsComponent_div_37_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 25);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](1, "div", 26);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](2, "div", 27);
...
function EventDetailsComponent_button_38_Template(rf, ctx) { if (rf & 1) {
    const _r30 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "button", 33);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("touchrelease", function EventDetailsComponent_button_38_Template_button_touchrelease_0_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r30); const ctx_r29 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r29.show_attendees = !ctx_r29.show_attendees; });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} if (rf & 2) {
...
function EventDetailsComponent_div_43_Template(rf, ctx) { if (rf & 1) {
...
function EventDetailsComponent_button_45_Template(rf, ctx) { if (rf & 1) {
    const _r32 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "button", 39);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("tapped", function EventDetailsComponent_button_45_Template_button_tapped_0_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r32); const ctx_r31 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r31.checkin(); });
...
function EventDetailsComponent_button_46_Template(rf, ctx) { if (rf & 1) {
    const _r34 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "button", 40);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("tapped", function EventDetailsComponent_button_46_Template_button_tapped_0_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r34); const ctx_r33 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r33.edit(); });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1, "Edit");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} }
function EventDetailsComponent_button_47_Template(rf, ctx) { if (rf & 1) {
    const _r36 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "button", 41);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("tapped", function EventDetailsComponent_button_47_Template_button_tapped_0_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r36); const ctx_r35 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r35.duplicate(); });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1, "Duplicate");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} }
class EventDetailsComponent extends src_app_shared_base_directive__WEBPACK_IMPORTED_MODULE_3__["BaseDirective"] {
    constructor(_users, _dialog, _router) {
        super();
        this._users = _users;
        this._dialog = _dialog;
    ...
    get when() {
        ...
        const date = dayjs__WEBPACK_IMPORTED_MODULE_7__(this.event.date);
    ...
    get status() {
        if (this.event) {
            const now = dayjs__WEBPACK_IMPORTED_MODULE_7__();
            const date = dayjs__WEBPACK_IMPORTED_MODULE_7__(this.event.date);
            /* istanbul ignore else */
    ...
    get is_checked_in() {
        return this.spaces.reduce((a, v) => a && this.event.date <= (this.last_start[v.id] || 0), true);
    }
    ...
    locate(space) {
        /* istanbul ignore else */
        if (space) {
            this._dialog.open(src_app_overlays_view_room_modal_view_room_modal_component__WEBPACK_IMPORTED_MODULE_6__["ViewRoomModalComponent"], {
                width: 'auto',
                height: 'auto',
                maxWidth: '95vw',
                maxHeight: '95vh',
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](EventDetailsComponent, [{
    ...
    }], function () { return [{ type: src_app_services_data_users_users_service__WEBPACK_IMPORTED_MODULE_8__["UsersService"] }, { type: _angular_material_dialog__WEBPACK_IMPORTED_MODULE_1__["MatDialog"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] }]; }, { event: [{
            type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"]
        }], change: [{
            type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"]
        }], loading: [{
...
/* harmony import */ var src_app_shell_bookings_overlays_booking_confirm_booking_confirm_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! src/app/shell/bookings/overlays/booking-confirm/booking-confirm.component */ "./src/app/shell/bookings/overlays/booking-confirm/booking-confirm.component.ts");
/* harmony import */ var src_app_services_data_users_users_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! src/app/services/data/users/users.service */ "./src/app/services/data/users/users.service.ts");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/__ivy_ngcc__/fesm2015/common.js");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/__ivy_ngcc__/fesm2015/forms.js");
/* harmony import */ var _shared_components_forms_booking_form_booking_form_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../../../shared/components/forms/booking-form/booking-form.component */ "./src/app/shared/components/forms/booking-form/booking-form.component.ts");
...
function EventEditComponent_form_1_Template(rf, ctx) { if (rf & 1) {
    const _r2 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "form", 2);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngSubmit", function EventEditComponent_form_1_Template_form_ngSubmit_0_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r2); const ctx_r1 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r1.save(); });
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("tapped", function EventEditComponent_form_1_Template_button_tapped_4_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r2); const ctx_r3 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r3.cancel(); });
...
class EventEditComponent extends src_app_shared_base_directive__WEBPACK_IMPORTED_MODULE_2__["BaseDirective"] {
    ...
    ngOnInit() {
        /* istanbul ignore else */
        if (this.event) {
            this.form = Object(src_app_services_data_bookings_booking_utilities__WEBPACK_IMPORTED_MODULE_5__["generateBookingForm"])(this.event, this._users.current, this._service.setting('app.booking.show_fields') || []);
        }
    }
    ngOnChanges(changes) {
        /* istanbul ignore else */
    ...
    save() {
        ...
        /* istanbul ignore else */
        if (this.form.valid) {
            const dialog_ref = this._dialog.open(src_app_shell_bookings_overlays_booking_confirm_booking_confirm_component__WEBPACK_IMPORTED_MODULE_6__["BookingConfirmComponent"], {
                width: '32em',
                maxWidth: '95vw',
                maxHeight: '95vh',
...
EventEditComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: EventEditComponent, selectors: [["schedule-event-edit"]], inputs: { event: "event" }, outputs: { change: "change", loading: "loading" }, features: [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵInheritDefinitionFeature"], _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵNgOnChangesFeature"]], decls: 2, vars: 1, consts: [[1, "event-edit"], [3, "formGroup", "ngSubmit", 4, "ngIf"], [3, "formGroup", "ngSubmit"], [1, "body"], [3, "form"], [1, "footer"], ["mat-button", "", "type", "button", "name", "cancel", 1, "inverse", 3, "tapped"], ["mat-button", "", "type", "submit"]], template: function EventEditComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](EventEditComponent, [{
    ...
    }], function () { return [{ type: src_app_services_app_service__WEBPACK_IMPORTED_MODULE_4__["ApplicationService"] }, { type: src_app_services_data_users_users_service__WEBPACK_IMPORTED_MODULE_7__["UsersService"] }, { type: _angular_material_dialog__WEBPACK_IMPORTED_MODULE_1__["MatDialog"] }]; }, { event: [{
            type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"]
        }], change: [{
            type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"]
        }], loading: [{
...
/* harmony import */ var src_app_shared_base_directive__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/shared/base.directive */ "./src/app/shared/base.directive.ts");
/* harmony import */ var src_app_services_app_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/services/app.service */ "./src/app/services/app.service.ts");
/* harmony import */ var src_app_services_data_bookings_bookings_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/services/data/bookings/bookings.service */ "./src/app/services/data/bookings/bookings.service.ts");
...
/* harmony import */ var _event_details_event_details_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./event-details/event-details.component */ "./src/app/shell/schedule/view-event/event-details/event-details.component.ts");
/* harmony import */ var _event_edit_event_edit_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./event-edit/event-edit.component */ "./src/app/shell/schedule/view-event/event-edit/event-edit.component.ts");
...
function ScheduleViewEventComponent_ng_container_20_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerStart"](0);
...
function ScheduleViewEventComponent_ng_container_22_Template(rf, ctx) { if (rf & 1) {
    const _r5 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerStart"](0);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "schedule-event-details", 19);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function ScheduleViewEventComponent_ng_container_22_Template_schedule_event_details_change_1_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r5); const ctx_r4 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r4.onChange($event); })("loading", function ScheduleViewEventComponent_ng_container_22_Template_schedule_event_details_loading_1_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r5); const ctx_r6 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r6.loading = $event; });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerEnd"]();
} if (rf & 2) {
    const ctx_r1 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();
...
function ScheduleViewEventComponent_ng_template_23_Template(rf, ctx) { if (rf & 1) {
    const _r8 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "schedule-event-edit", 19);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function ScheduleViewEventComponent_ng_template_23_Template_schedule_event_edit_change_0_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r8); const ctx_r7 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r7.onChange($event); })("loading", function ScheduleViewEventComponent_ng_template_23_Template_schedule_event_edit_loading_0_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r8); const ctx_r9 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r9.loading = $event; });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} if (rf & 2) {
    const ctx_r3 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("event", ctx_r3.event);
} }
const _c0 = function (a2) { return ["/schedule", "view", a2]; };
const _c1 = function () { return ["/schedule"]; };
class ScheduleViewEventComponent extends src_app_shared_base_directive__WEBPACK_IMPORTED_MODULE_2__["BaseDirective"] {
    constructor(_service, _bookings, _router) {
        super();
        this._service = _service;
        this._bookings = _bookings;
        this._router = _router;
    ...
    ngOnInit() {
        this.subscription('arrow_right', this._service.Hotkeys.listen(['ArrowRight'], () => this.nextBooking()));
        this.subscription('arrow_left', this._service.Hotkeys.listen(['ArrowLeft'], () => this.previousBooking()));
        this.subscription('changes', this._bookings.listen('list').subscribe(() => this.loadEvent()));
    }
    ngOnChanges(changes) {
        /* istanbul ignore else */
    ...
    loadEvent() {
        ...
        if (booking) {
            ...
            this._bookings.show(this.id, {}).then((bkn) => {
                this.loading = '';
                this.event = bkn;
            }, () => {
                this.loading = '';
...
ScheduleViewEventComponent.ɵfac = function ScheduleViewEventComponent_Factory(t) { return new (t || ScheduleViewEventComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_services_app_service__WEBPACK_IMPORTED_MODULE_3__["ApplicationService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_services_data_bookings_bookings_service__WEBPACK_IMPORTED_MODULE_4__["BookingsService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"])); };
ScheduleViewEventComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ScheduleViewEventComponent, selectors: [["schedule-view-event"]], inputs: { id: "id", next: "next", previous: "previous" }, features: [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵInheritDefinitionFeature"], _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵNgOnChangesFeature"]], decls: 25, vars: 18, consts: [[1, "event-display"], [1, "header"], [1, "icon"], [1, "details"], ["mat-icon-button", "", "name", "previous", 3, "routerLink"], [1, "left", "icon"], [1, "material-icons"], [1, "title"], ["mat-icon-button", "", "name", "next", 3, "routerLink"], [1, "right", "icon"], ["mat-icon-button", "", 3, "routerLink"], [1, "body"], [1, "content"], [4, "ngIf"], [4, "ngIf", "ngIfElse"], ["edit_form", ""], [1, "no-item", "center"], ["diameter", "48"], [1, "text"], [3, "event", "change", "loading"]], template: function ScheduleViewEventComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "div", 1);
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ScheduleViewEventComponent, [{
    ...
    }], function () { return [{ type: src_app_services_app_service__WEBPACK_IMPORTED_MODULE_3__["ApplicationService"] }, { type: src_app_services_data_bookings_bookings_service__WEBPACK_IMPORTED_MODULE_4__["BookingsService"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"] }]; }, { id: [{
            type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"]
        }], next: [{
            type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"]
        }], previous: [{
...
//# sourceMappingURL=shell-schedule-schedule-module-es2015.js.map