...
/* harmony import */ var _acaprojects_ngx_date_picker__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! @acaprojects/ngx-date-picker */ "./node_modules/@acaprojects/ngx-date-picker/__ivy_ngcc__/fesm2015/acaprojects-ngx-date-picker.js");
...
/* harmony import */ var _list_item_list_item_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./list-item/list-item.component */ "./src/app/shell/schedule/event-list/list-item/list-item.component.ts");
...
class ScheduleEventListComponent extends src_app_shared_base_directive__WEBPACK_IMPORTED_MODULE_5__["BaseDirective"] {
    constructor(_service, _route) {
        ...
        this.date_offset = 0;
        /** Current UTC epoch */
        this.now = dayjs__WEBPACK_IMPORTED_MODULE_6__().valueOf();
    ...
    ngOnInit() {
        this.subscription('route.query', this._route.queryParamMap.subscribe(params => {
            ...
            if (params.has('email')) {
                this.active_user = this._service.Users.find(params.get('email')) || new src_app_services_data_users_user_class__WEBPACK_IMPORTED_MODULE_7__["User"](this._service.Users, { email: params.get('email') });
            }
        }));
        this.updateEvents();
    ...
    updateEvents() {
        ...
        if (!this.event_promise) {
            this.event_promise = new Promise(resolve => {
                const start = dayjs__WEBPACK_IMPORTED_MODULE_6__()
                ...
                this._service.Bookings.query({
                    ...
                    const old_events = this.events.filter(i => {
                        const date = dayjs__WEBPACK_IMPORTED_MODULE_6__(i.date);
                        return (i.type !== 'date' &&
                            i.type !== 'empty' &&
    ...
    processEvents(list, old_events) {
        ...
        for (; date.isBefore(end); date = date.add(1, 'd')) {
            ...
            const filter_fn = i => {
                const day = dayjs__WEBPACK_IMPORTED_MODULE_6__(i.date);
    ...
    onScroll() {
        ...
        if (!this.event_promise) {
            ...
            this.date = dayjs__WEBPACK_IMPORTED_MODULE_6__((this.events[dist + range.start] || {}).date)
                .subtract(1, 'd')
                .valueOf();
            /* istanbul ignore else */
    ...
    updateDate(date) {
        ...
        delete this.event_promise;
        this.show_calendar = false;
        this.date = dayjs__WEBPACK_IMPORTED_MODULE_6__()
            .add(this.date_offset, 'd')
            .valueOf();
        this.updateEvents();
    }
...
ScheduleEventListComponent.ɵfac = function ScheduleEventListComponent_Factory(t) { return new (t || ScheduleEventListComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_app_service__WEBPACK_IMPORTED_MODULE_3__["ApplicationService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_1__["ActivatedRoute"])); };
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ScheduleEventListComponent, [{
        ...
        args: [{
    ...
    }], function () { return [{ type: _services_app_service__WEBPACK_IMPORTED_MODULE_3__["ApplicationService"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_1__["ActivatedRoute"] }]; }, { event_list: [{
            ...
            type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"],
            args: [_angular_material_menu__WEBPACK_IMPORTED_MODULE_8__["MatMenuTrigger"], { static: true }]
        }] }); })();
...
/* harmony import */ var src_app_services_data_users_user_class__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! src/app/services/data/users/user.class */ "./src/app/services/data/users/user.class.ts");
...
class ScheduleEventListItemComponent extends src_app_shared_base_directive__WEBPACK_IMPORTED_MODULE_2__["BaseDirective"] {
    ...
    get time() {
        ...
        return booking.all_day || booking.duration > 23 * 60
            ? 'All Day'
            : dayjs__WEBPACK_IMPORTED_MODULE_7__(booking.date).format('h:mm A');
    }
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ScheduleEventListItemComponent, [{
    ...
    }], function () { return [{ type: _angular_material_dialog__WEBPACK_IMPORTED_MODULE_1__["MatDialog"] }, { type: src_app_services_app_service__WEBPACK_IMPORTED_MODULE_5__["ApplicationService"] }]; }, { event: [{
...
/* harmony import */ var src_app_overlays_view_room_modal_view_room_modal_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! src/app/overlays/view-room-modal/view-room-modal.component */ "./src/app/overlays/view-room-modal/view-room-modal.component.ts");
...
class EventDetailsComponent extends src_app_shared_base_directive__WEBPACK_IMPORTED_MODULE_3__["BaseDirective"] {
    ...
    get when() {
        ...
        const date = dayjs__WEBPACK_IMPORTED_MODULE_8__(this.event.date);
    ...
    get status() {
        if (this.event) {
            const now = dayjs__WEBPACK_IMPORTED_MODULE_8__();
            const date = dayjs__WEBPACK_IMPORTED_MODULE_8__(this.event.date);
            /* istanbul ignore else */
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](EventDetailsComponent, [{
    ...
    }], function () { return [{ type: src_app_services_app_service__WEBPACK_IMPORTED_MODULE_6__["ApplicationService"] }, { type: _angular_material_dialog__WEBPACK_IMPORTED_MODULE_1__["MatDialog"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] }]; }, { event: [{
            type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"]
        }], change: [{
            type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"]
        }], loading: [{
...
/* harmony import */ var _shared_components_forms_booking_form_booking_form_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../../../shared/components/forms/booking-form/booking-form.component */ "./src/app/shared/components/forms/booking-form/booking-form.component.ts");
/* harmony import */ var _angular_material_button__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @angular/material/button */ "./node_modules/@angular/material/__ivy_ngcc__/fesm2015/button.js");
/* harmony import */ var _acaprojects_ngx_custom_events__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @acaprojects/ngx-custom-events */ "./node_modules/@acaprojects/ngx-custom-events/__ivy_ngcc__/fesm2015/acaprojects-ngx-custom-events.js");
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](EventEditComponent, [{
    ...
    }], function () { return [{ type: src_app_services_app_service__WEBPACK_IMPORTED_MODULE_4__["ApplicationService"] }, { type: _angular_material_dialog__WEBPACK_IMPORTED_MODULE_1__["MatDialog"] }]; }, { event: [{
            type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"]
        }], change: [{
            type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"]
        }], loading: [{
...
/* harmony import */ var _event_details_event_details_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./event-details/event-details.component */ "./src/app/shell/schedule/view-event/event-details/event-details.component.ts");
/* harmony import */ var _event_edit_event_edit_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./event-edit/event-edit.component */ "./src/app/shell/schedule/view-event/event-edit/event-edit.component.ts");
...
class ScheduleViewEventComponent extends src_app_shared_base_directive__WEBPACK_IMPORTED_MODULE_2__["BaseDirective"] {
    ...
    ngOnInit() {
        ...
        this.subscription('changes', this._service.Bookings.listen('list').subscribe(() => this.loadEvent()));
    }
    ngOnChanges(changes) {
        /* istanbul ignore else */
    ...
    loadEvent() {
        ...
        if (booking) {
            ...
            this._service.Bookings.show(this.id, {}).then(bkn => {
                this.loading = '';
                this.event = bkn;
            }, () => {
                this.loading = '';
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ScheduleViewEventComponent, [{
    ...
    }], function () { return [{ type: src_app_services_app_service__WEBPACK_IMPORTED_MODULE_3__["ApplicationService"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"] }]; }, { id: [{
            type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"]
        }], next: [{
            type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"]
        }], previous: [{
